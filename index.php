...
<html lang="en">
    ...
    <body  id="page-top" data-spy="scroll" data-target=".navbar" data-offset="100">
        ...
        <!-- Intro Area
        ===================================== -->
        <header class="intro pt100 pb100 parallax-window" data-parallax="scroll" data-speed="0.5" data-image-src="assets/img/Facebook.png">
                            ...
                            <h1 class="brand-heading text-capitalize color-light pt10 pb10">
                                 <div class="brand-heading-typed-container">
                                    <div id="typed-strings">
                                      <span>
                                        <p>Welcome to <span class="color-pasific">Facebot</span></p>
